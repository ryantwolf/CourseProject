...
class BM25 {
    /**
     * Initialize all counts to 0 and create empty dictionaries
     */
    constructor() {
     ...
     * @returns The new id of the document
     */
    ...
    /**
     * Add a series of documents to the index
     * @param {Array} doc_text_list 
     */
    ...
    /**
     * Searches the index for the query and returns the top num_results documents
     * @param {String} query 
     * @param {Number} num_results 
     * @returns A list of the top num_results documents
     */
